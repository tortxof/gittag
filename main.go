...
func printBashCompletions() {
    ...
    flags="-v -version -n -dry-run -f -file -bash-completions"
...
var bashCompletions bool

func init() {
	flag.BoolVar(&bashCompletions, "bash-completions", false, "Output bash completion script")
}
